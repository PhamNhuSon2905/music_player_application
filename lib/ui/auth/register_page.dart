    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        if (errors is Map) {
          ...
          ToastHelper.show(context, message: combinedError, isSuccess: false);
        } else {
          ToastHelper.show(context, message: "Đăng ký tài khoản thất bại: $errors", isSuccess: false);
        }
      } else {
        final error = response.body.isNotEmpty ? response.body : "Lỗi không xác định.";
        ToastHelper.show(context, message: "Đăng ký tài khoản thất bại: $error", isSuccess: false);
      }
    } catch (e) {
      ToastHelper.show(context, message: "Lỗi mạng: $e", isSuccess: false);
    } finally {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          ...
                          return emailRegex.hasMatch(value.trim())
                              ? null
                              : "Không hợp lệ. Vui lòng nhập đúng định dạng email!";
                        },
                      ),
                      const SizedBox(height: 12),
                      TextFormField(
                      ...
                      TextFormField(
                        ...
                        style: const TextStyle(color: Colors.black87, fontFamily: 'SF Pro'),
                        decoration:
                        _inputDecoration("Mật khẩu", Icons.lock_outline),
                      ...
                      TextFormField(
                        ...
                        decoration: _inputDecoration(
                            "Xác nhận lại mật khẩu", Icons.lock_outline),
                        validator: (value) =>
                      ...
                      TextButton(
                        ...
                        child: const Text(
                          ...
                          style: TextStyle(
                              color: Colors.purple, fontFamily: 'SF Pro'),
                        ),
                      ),
                    ],
                  ),
